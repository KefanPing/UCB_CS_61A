...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
    	...
    	if who == 0:
    		...
    		score0 += take_turn(strategy0(player_score, opponent_score), opponent_score, dice, goal)
    		player_score = score0
    	else:
    		player_score = score1
    		opponent_score = score0
    		score1 += take_turn(strategy1(player_score, opponent_score), opponent_score, dice, goal)
    		player_score = score1
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
    	if who == 0:
    		...
    		now_score = score1
    	gain = now_score - last_score
    	gain_high = running_high
    	if gain > gain_high:
    		gain_high = gain
    		print('Player', who, 'has reached a new maximum point gain.', gain_high, 'point(s)!')
    	return announce_highest(who,last_score=now_score, running_high=gain_high)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    max_scoring = make_averaged(roll_dice,trials_count)(1,dice)
    result = 1
    counter = 2
    while counter <= 10:
    	scoring = make_averaged(roll_dice,trials_count)(counter,dice)
    	if max_scoring < scoring:
    		max_scoring = scoring
    		result = counter
    	counter += 1
    return result
